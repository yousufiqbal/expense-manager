...
<div class="field">
  ...
  <input on:keyup class:readonly {readonly} step={type == 'time' ? '1' : ''} bind:this={el} on:focus on:blur={touch} {inputmode} use:typeMe id={attr} name={attr} {placeholder} bind:value size="1">
